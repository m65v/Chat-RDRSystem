...
start() -> 
    connect("Mayra", 22, "1234", "general", "mayra").


test() ->
    connect("Mayra", 22, "1234", "general", "mayra"),
    connect("Mayra", 22, "1234", "general", "filip"),
    connect("Mayra", 22, "1234", "general", "kit"),
    connect("Mayra", 22, "1234", "general", "bianca"),
	connect("Mayra", 22, "1234", "general", "nino"),
	connect("Mayra", 22, "1234", "general", "mika").
